...
if DEBUG:
    ...
    EMAIL_SEND_USERNAME = 'lilycui@pateo.com.cn'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
    EMAIL_SEND_PASSWORD = 'lq@430430'  # 邮箱密码
    STATICFILES_DIRS = (
...
BROKER_URL = 'amqp://guest:guest@127.0.0.1:5672//' #127.0.0.1 即为rabbitmq-server所在服务器ip地址
